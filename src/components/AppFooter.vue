<template>
  <div class="relative mt-16 bg-red-500">
    <svg
      class="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-red-500"
    ...
    <div class="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        ...
        <div class="md:max-w-md lg:col-span-2">
          ...
          <div class="mt-4 lg:max-w-sm">
            <p class="text-sm text-deep-purple-50">
              ...
              products, from farm to table, improving transparency and accountability in the food
              supply chain.
            </p>
            <p class="mt-4 text-sm text-deep-purple-50">
              Get detailed information about the specific farm, the production process, and even the
      ...
      <div class="flex flex-col justify-between pt-5 pb-10 border-t border-black sm:flex-row">
        <p class="text-sm text-black-100">© Copyright 2023 Transpareat Inc. All rights reserved.</p>
        <div class="flex items-center mt-4 space-x-4 sm:mt-0">
          <a
            href="https://twitter.com/transpareat"
            target="_blank"
